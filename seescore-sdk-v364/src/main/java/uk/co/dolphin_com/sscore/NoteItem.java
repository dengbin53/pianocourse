...
public class NoteItem extends TimedItem
{
	...
	public NoteItem baseNoteItem() { return this; }

	public String toString()
	{
		StringBuilder sb = new StringBuilder();
		sb.append(super.toString());
		if (type == ItemType_note) // else rest
	...
	NoteItem(int staff, int item_h, int start, int duration,
	...
	assert(itemtype != ItemType_note || midipitch > 0);
